...
JAVA_OPTS="$JAVA_OPTS -Dpublisher.metadata.dataset=http://$PUBLISHER_DAV_DOMAIN/metadata/dataset/"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.metadata.service=http://$PUBLISHER_DAV_DOMAIN/metadata/service/"
