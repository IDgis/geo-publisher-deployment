...
if [ "$PUBLISHER_GEOSERVER_GENERATE_NAME" == "true" ]; then
	...
	PUBLISHER_GEOSERVER_SECURE_NAME="geoserver-staging"
	PUBLISHER_GEOSERVER_PUBLIC_NAME="geoserver-staging"
	PUBLISHER_GEOSERVER_GUARANTEED_NAME="geoserver-staging"
fi
