...
PUBLISHER_DATA_SOURCE_ID="vector"
PUBLISHER_DATA_SOURCE_NAME="My Vector Provider Name"
PUBLISHER_RASTER_DATA_SOURCE_ID="raster"
PUBLISHER_RASTER_DATA_SOURCE_NAME="My Raster Provider Name"
...
PUBLISHER_DAV_TRUSTED_ADDRESSES="127.0.0.1,::1"
PUBLISHER_PUBLIC_ENVIRONMENT_NAME="Publieke services"
PUBLISHER_SECURE_ENVIRONMENT_NAME="Beveiligde services"
PUBLISHER_GUARANTEED_ENVIRONMENT_NAME="Gegarandeerde services"
PUBLISHER_TIMEZONE="Europe/Amsterdam"
...
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_RASTER_DATA_SOURCE_ID=\"$PUBLISHER_RASTER_DATA_SOURCE_ID\""
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_RASTER_DATA_SOURCE_NAME=\"$PUBLISHER_RASTER_DATA_SOURCE_NAME\""
...
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_DAV_TRUSTED_ADDRESSES=\"$PUBLISHER_DAV_TRUSTED_ADDRESSES\""
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_PUBLIC_ENVIRONMENT_NAME=\"$PUBLISHER_PUBLIC_ENVIRONMENT_NAME\""
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_SECURE_ENVIRONMENT_NAME=\"$PUBLISHER_SECURE_ENVIRONMENT_NAME\""
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_GUARANTEED_ENVIRONMENT_NAME=\"$PUBLISHER_GUARANTEED_ENVIRONMENT_NAME\""
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_TIMEZONE=\"$PUBLISHER_TIMEZONE\""
DOCKER_ENV="$DOCKER_ENV -e PUBLISHER_DOWNLOAD_URL_PREFIX=\"$PUBLISHER_DOWNLOAD_URL_PREFIX\""
