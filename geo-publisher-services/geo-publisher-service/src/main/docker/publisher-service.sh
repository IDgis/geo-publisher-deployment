...
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.datasetTarget=/var/lib/geo-publisher/dav/metadata/dataset"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.serviceTarget=/var/lib/geo-publisher/dav/metadata/service"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.environments.geoserver-public.serviceLinkagePrefix=http://$PUBLISHER_GEOSERVER_PUBLIC_DOMAIN/geoserver/"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.environments.geoserver-public.datasetMetadataPrefix=http://$PUBLISHER_DAV_DOMAIN/dav/metadata/dataset/geoserver-public/"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.environments.geoserver-secure.serviceLinkagePrefix=https://$PUBLISHER_GEOSERVER_SECURE_DOMAIN/geoserver/"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.environments.geoserver-secure.datasetMetadataPrefix=https://$PUBLISHER_DAV_DOMAIN/dav/metadata/dataset/geoserver-secure/"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.environments.geoserver-guaranteed.serviceLinkagePrefix=http://$PUBLISHER_GEOSERVER_GUARANTEED_DOMAIN/geoserver/"
JAVA_OPTS="$JAVA_OPTS -Dpublisher.service.metadata.environments.geoserver-guaranteed.datasetMetadataPrefix=http://$PUBLISHER_DAV_DOMAIN/dav/metadata/dataset/geoserver-guaranteed/"
